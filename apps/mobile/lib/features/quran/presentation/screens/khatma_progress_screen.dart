          ...
          SliverToBoxAdapter(
            child: Column(
              children: [
                ...
                const SizedBox(height: 30),
                // Stats row
                _buildStatsRow(context, l, style, khatma, historyAsync),
                const SizedBox(height: 30),
                // Weekly chart
                _buildWeeklyChart(context, l, style),
                const SizedBox(height: 30),
              ],
            ),
          ),
      ...
      child: Row(
        children: [
          _StatCard(
            ...
            label: l.khatmaStatCompletedLabel,
          ...
          _StatCard(
            ...
            label: l.khatmaStatPagesPerDayLabel,
